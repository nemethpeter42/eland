...
export class Summary extends React.Component {
	...
	parseRawMeanings(meanings){
		let meaningGroupDelimiter = ';'
		let meaningGroups = meanings.split(meaningGroupDelimiter).forEach(e => e.trim()).filter(e => e!=='')
		...
		<div className='word-card'>
			...
			<div className='meaning'>
				...
				<div className='random-light-color-3 meaning-group'>
					...
					<div className='meaning-group-level-comment'>
						(le~/fel~)
					</div>
				</div>
